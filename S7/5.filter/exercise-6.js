...
let streamersSeleccionados = streamers.filter(stream => stream.gameMorePlayed.includes("Legends") && stream.age>35)
streamersSeleccionados.forEach(stream => { stream.gameMorePlayed = stream.gameMorePlayed.toUpperCase()})
